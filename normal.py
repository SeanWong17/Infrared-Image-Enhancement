...
def main() -> int:
    ...
    parser.add_argument("-i", "--input_dir", default="examples/raw", help="Input directory containing TIFF files.")
    parser.add_argument("-o", "--output_dir", default="examples/linear", help="Output directory for normalized images.")
